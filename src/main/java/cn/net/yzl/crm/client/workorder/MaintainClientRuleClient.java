 ...
 * 顾客维护总数量规则校验
 */
@FeignClient(name = "maintainClientRuleClient", url = "${api.gateway.url}/workorderServer/maintainClientRule")
//@FeignClient(name = "maintainClientRuleClient", url = "127.0.0.1:4602/maintainClientRule")
