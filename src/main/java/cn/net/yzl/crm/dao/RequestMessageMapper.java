...
public interface RequestMessageMapper {
	 ...
	 */
	@Insert("insert into request_message (message_code,bus_code,request_url,request_param,create_code,update_code) values (#{messageCode},#{busCode},#{requestUrl},#{requestParam},#{createCode},#{updateCode})")
