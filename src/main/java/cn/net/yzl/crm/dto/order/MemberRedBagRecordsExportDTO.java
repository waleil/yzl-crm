...
@Data
@ApiModel("顾客红包——导出对象")
public class MemberRedBagRecordsExportDTO implements Serializable {

    private static final long serialVersionUID = -8184023269834661098L;
    ...
    @ExcelProperty(value = {"顾客红包"}, index = 5)
