...
import cn.net.yzl.model.vo.OrderDistributeExpressRuleEditVO;
...
public class OrderOprServiceImpl implements IOrderOprService {
    ...
    private void aggreeOrder( OrderCheckDetailDTO dto, OrderInfoVo orderInfoVo) {
        ...
        OrderDistributeExpressVO vo = mkOrderDistributeExpressData(orderInfoVo);
        list.add(vo);
    ...
    private OrderDistributeExpressVO mkOrderDistributeExpressData(OrderInfoVo orderInfoVo) {
...
//        vo.setOrderAfterSpare();
//        vo.setOrderAfterRed();
//        vo.setOrderAfterRebate();
//        vo.setOrderAfterIntegral();
//        vo.setUseSpareMoney();
//        vo.setCreateUser();
//        vo.setOrderProductVoList();
return null;
