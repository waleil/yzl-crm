...
public class OrderSaleController {
    ...
    public ComResponse<List<OrderSaleListVO>> selectOrderSaleList(@RequestParam(required = false,name = "orderNo") @ApiParam(value = "订单编号", name = "orderNo") String orderNo,
                                                                  ...
                                                                  @RequestParam(required = false,name = "pageSize") @ApiParam(value = "返货类型", name = "pageSize") Integer pageSize,
                                                                  @RequestParam(required = false,name = "pageNum") @ApiParam(value = "返货类型", name = "pageNum") Integer pageNum) {
    ...
    public ComResponse<OrderSaleCheckDetailVO> selectOrderSaleCheckInfo(@RequestParam(name="saleOrderNo") @NotBlank(message = "售后订单不能为空") @ApiParam(name = "saleOrderNo", value = "售后单号") String saleOrderNo) {
...
//                orderSaleMemberInfo.setMemberCoupon(member.getMember_amount().getLast_coupon());
    ...
    public ComResponse<OrderSaleDetailVO> selectOrderSaleInfo(@RequestParam(required = false,name = "orderNo") @ApiParam(name = "orderNo", value = "订单编号") String orderNo,
    ...
    public ComResponse<Boolean> updateOrderSaleState(@RequestParam(name = "orderSaleNo") @NotBlank(message = "售后单状态不能为空") @ApiParam(name = "orderSaleNo", value = "售后单号", required = true) String orderSaleNo,
    ...
    public ComResponse<List<OrderSaleCheckListVO>> selectOrderSaleCheckList(@RequestParam(required = false,name = "orderNo") @ApiParam(name = "orderNo", value = "订单编号") String orderNo
    ...
    public ComResponse<OrderSaleDetailVO> selectOrderSaleProductInfoByOrderNo(@RequestParam(name = "orderNo") @ApiParam(name = "orderNo",value = "订单编号") String orderNo) {
